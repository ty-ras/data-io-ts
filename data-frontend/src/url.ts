/**
 * @file This file contains `io-ts` -specific code on defining URL path portion for invoking endpoints on frontend side.
 */

import type * as protocol from "@ty-ras/protocol";
import type * as data from "@ty-ras/data";
import * as dataIO from "@ty-ras/data-io-ts";
...
>(
  ...
  return dataFE.urlGeneric<dataIO.ValidatorHKT, TArgs>(
    fragments,
    args,
    // io-ts, unlike @effect/schema, glues encoder and decoder together, thus needing us to skip type checks
 ...
 * @param encoder The runtime validation of URL path parameter, as `io-ts` object.
